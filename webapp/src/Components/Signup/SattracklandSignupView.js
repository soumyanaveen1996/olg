...
import SignupHeader from "./CustomLanding/SignupHeader";
...
function SattracklandSignupView(props) {
	...
	//exp
	const modifyAuthCode = (e) =>
		setState({ ...state, authCode: e.target.value });
	//exp
	...
	return (
		<div className="container-fluid">
			<div
				style={{
					flex: 4,
					background: `url(${THURAYA_T2M_SIGNUP_BACKGROUND})`,
			...
			>
				<div className="col-12 col-sm-8 offset-sm-2 col-md-8 offset-md-2 col-lg-4 offset-lg-4">
					<div
						className="rounded shadow-sm overflow-hidden pt-4 pb-4"
						style={{ background: "rgba(9,69,116, 0.7)" }}
					>
						<div className="row justify-content-center">
							<div className="col-sm-12">
								<div className="pt-4 pb-4 text-white text-center">
									<SignupHeader landingPath={THURAYA_T2M_LANDING} />
								</div>
							</div>
								...
								<div className="text-center text-white">
									...
									>
										<div>
											...
											{/* exp */}
											<div className="form-group">
												<label htmlFor="inputLicense">License Key</label>
												<input
													id="inputLicensee"
													placeholder="License Key"
													type="text"
													className="form-control form-content-input textBox-rev text-dark"
													onChange={modifyAuthCode}
...
export default connect(null, mapStateToProps)(SattracklandSignupView);
