...
$root.ping = (function () {
	...
	ping.PingService = (function () {
		...
		(PingService.prototype = Object.create(
		 ...
		 */
		PingService.create = function create(
			rpcImpl,
			requestDelimited,
			responseDelimited
		) {
		 ...
		 * @param {ping.PingReply} [response] PingReply
		 */
		 ...
		 * @param {ping.PingService.PingCallback} callback Node-style callback called with the error, if any, and PingReply
		 * @returns {undefined}
		 * @variation 1
		 */
		 ...
		 * @instance
		 * @param {commonmessages.IEmpty} request Empty message or plain object
		 * @returns {Promise<ping.PingReply>} Promise
		 * @variation 2
		 */
	...
	ping.PingReply = (function () {
		 ...
		 * @constructor
		 * @param {ping.IPingReply=} [properties] Properties to set
		 */
		 ...
		 * @static
		 * @param {ping.IPingReply=} [properties] Properties to set
		 * @returns {ping.PingReply} PingReply instance
		 */
		...
		/**
		 * Encodes the specified PingReply message. Does not implicitly {@link ping.PingReply.verify|verify} messages.
		 * @function encode
		 * @memberof ping.PingReply
		 * @static
		 * @param {ping.IPingReply} message PingReply message or plain object to encode
		...
		/**
		 * Encodes the specified PingReply message, length delimited. Does not implicitly {@link ping.PingReply.verify|verify} messages.
		 ...
		 * @returns {ping.PingReply} PingReply
		...
		PingReply.decode = function decode(reader, length) {
			...
			var end = length === undefined ? reader.len : reader.pos + length,
				message = new $root.ping.PingReply();
		...
		PingReply.fromObject = function fromObject(object) {
			if (object instanceof $root.ping.PingReply) return object;
			var message = new $root.ping.PingReply();
		 ...
		 * @memberof ping.PingReply
		 * @static
		 * @param {ping.PingReply} message PingReply
