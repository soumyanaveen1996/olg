...
!(function (a) {
	...
	function g(a, b) {
		f.call(this, a), (this.data = b.data), (this.lastEventId = b.lastEventId);
	}
	function h(a, b) {
		d.call(this),
			(this.onopen = void 0),
	...
	function i(a, b, d) {
		...
		var h = void 0 != d && Boolean(d.withCredentials),
			...
			R = function (b) {
				if (I === s) {
					for (var c = -1, d = 0; d < b.length; d += 1) {
						...
						(e === "\n".charCodeAt(0) || e === "\r".charCodeAt(0)) && (c = d);
					}
					var f = (-1 !== c ? M : "") + b.slice(0, c + 1);
					(M = (-1 === c ? M : "") + b.slice(c + 1)), "" !== f && (A = !0);
						...
						if (N === u && e === "\n".charCodeAt(0)) N = v;
							...
							if (N !== v) {
								...
								var l = f.slice(O, P - 1),
									m = f.slice(
										P +
											(h > P && f.charCodeAt(P) === " ".charCodeAt(0) ? 1 : 0),
										h
									);
								"data" === l
									? ((J += "\n"), (J += m))
							...
							if (N === v) {
								if ("" !== J) {
									(o = K), "" === L && (L = "message");
									var q = new g(L, { data: J.slice(1), lastEventId: K });
									if (
										(a.dispatchEvent(q),
										"message" === L && E(a, a.onmessage, q),
										I === t)
									)
										return;
								}
			...
			T = function () {
				(I = t), G.cancel(), 0 !== H && (k(H), (H = 0)), (a.readyState = t);
			},
			U = function () {
				if (((H = 0), I !== q))
					return void (A
						...
						: (e(
								new Error(
									"No activity within " + n + " milliseconds. Reconnecting."
								)
						  ),
						  G.cancel()));
				(A = !1),
				...
				if (((c.Accept = "text/event-stream"), void 0 != B))
					for (var d in B)
						Object.prototype.hasOwnProperty.call(B, d) && (c[d] = B[d]);
				try {
					G.open(Q, R, S, a, h, c);
				} catch (f) {
					throw (T(), f);
	...
	(b.prototype.open = function (a, b) {
		...
		this._abort = function (a) {
			0 !== c._sendTimeout && (k(c._sendTimeout), (c._sendTimeout = 0)),
				(1 === e || 2 === e || 3 === e) &&
					((e = 4),
					(d.onload = p),
					(d.onerror = p),
		...
		var g = function () {
				if (1 === e) {
					var a = 0,
						b = "",
						f = void 0;
					if ("contentType" in d) (a = 200), (b = "OK"), (f = d.contentType);
					else
						try {
							(a = d.status),
								(b = d.statusText),
			...
			h = function () {
				if ((g(), 2 === e || 3 === e)) {
					...
					(c.readyState = 3), (c.responseText = a), c.onprogress();
				}
			},
			i = function () {
				h(),
		...
		(d.prototype.addEventListener = function (a, b) {
			...
			var c = this._listeners,
				d = c[a];
			void 0 == d && ((d = []), (c[a] = d));
			for (var e = !1, f = 0; f < d.length; f += 1) d[f] === b && (e = !0);
			e || d.push(b);
		}),
